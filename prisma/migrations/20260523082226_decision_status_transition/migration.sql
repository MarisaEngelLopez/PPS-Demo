...
INSERT INTO "new_ProjectDecision" ("createdAt", "decision", "decisionCode", "decisionDate", "description", "dueDate", "escalated", "id", "impact", "isActive", "notes", "owner", "projectId", "projectWorkstreamId", "recommendation", "requestedBy", "status", "title", "updatedAt", "visibility") SELECT "createdAt", "decision", "decisionCode", "decisionDate", "description", "dueDate", "escalated", "id", "impact", "isActive", "notes", "owner", "projectId", "projectWorkstreamId", "recommendation", "requestedBy", "status", "title", "updatedAt", "visibility" FROM "ProjectDecision";
