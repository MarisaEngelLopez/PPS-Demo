...
INSERT INTO "new_Project" ("actualEndDate", "actualStartDate", "clientOrganizationId", "createdAt", "defaultLanguage", "deliveryOrganizationId", "description", "descriptionEs", "healthStatus", "id", "isActive", "issuerOrganizationId", "name", "nameEs", "plannedEndDate", "plannedStartDate", "projectCode", "projectManagerId", "projectTypeId", "reportLanguageMode", "reportingCadence", "secondaryLanguage", "showClientLogo", "showDeliveryLogo", "showIssuerLogo", "sponsorContactId", "sponsorId", "startDate", "statusId", "updatedAt") SELECT "actualEndDate", "actualStartDate", "clientOrganizationId", "createdAt", "defaultLanguage", "deliveryOrganizationId", "description", "descriptionEs", "healthStatus", "id", "isActive", "issuerOrganizationId", "name", "nameEs", "plannedEndDate", "plannedStartDate", "projectCode", "projectManagerId", "projectTypeId", "reportLanguageMode", "reportingCadence", "secondaryLanguage", "showClientLogo", "showDeliveryLogo", "showIssuerLogo", "sponsorContactId", "sponsorId", "startDate", "statusId", "updatedAt" FROM "Project";
DROP TABLE "Project";
...
CREATE TABLE "new_ProjectRiskAction" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "ProjectRiskAction_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "Status" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_ProjectRiskAction" ("createdAt", "description", "dueDate", "evidence", "id", "ownerId", "projectRiskId", "status", "updatedAt") SELECT "createdAt", "description", "dueDate", "evidence", "id", "ownerId", "projectRiskId", "status", "updatedAt" FROM "ProjectRiskAction";
...
CREATE INDEX "ProjectRiskAction_status_idx" ON "ProjectRiskAction"("status");
